...
// WireTap wraps the adapter's HTTP transport so every request/response
// is dumped UNREDACTED to out. Only the factory calls it, and only on a
// debug build with --trace-wire — see docs/security.md#debug-builds.
